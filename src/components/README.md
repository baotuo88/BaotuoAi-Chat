...
The `src/components` directory contains React UI for the Baotuo Chat application. Components are grouped by product area and should keep rendering concerns separate from shared library logic, API route logic, and store internals.
