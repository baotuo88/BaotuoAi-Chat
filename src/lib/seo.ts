import { BRAND_ALTERNATE_NAMES, BRAND_NAME } from "../config/brand";
...
export const SEO_SCREENSHOTS: SeoScreenshot[] = [
  {
    ...
    type: "image/png",
    form_factor: "wide",
    label: "Baotuo Chat desktop workspace screenshot",
  },
  {
    ...
    type: "image/png",
    form_factor: "narrow",
    label: "Baotuo Chat mobile workspace screenshot",
  },
];
...
export const SEO_CONTENT: Record<SeoLocale, SeoContent> = {
  en: {
    title: "Baotuo Chat - Local-first AI chat workspace",
    description:
      "Baotuo Chat is a local-first AI chat workspace for multi-model conversations, assistant presets, plugin tools, web search, knowledge-base RAG, voice, and artifacts.",
    keywords: [
      "Baotuo Chat",
      "AI chat",
      "local-first AI",
    ...
    ogTitle: "Baotuo Chat - Local-first AI chat workspace",
    ogDescription:
    ...
    ogImageAlt: "Baotuo Chat AI chat workspace",
  ...
  zh: {
    title: "Baotuo Chat - 本地优先的 AI 对话工作台",
    description:
      "Baotuo Chat 是本地优先的 AI 对话工作台，支持多模型对话、助理预设、插件工具、联网搜索、知识库 RAG、语音和可编辑产物。",
    keywords: [
      "Baotuo Chat",
      "AI 对话",
      "本地优先 AI",
    ...
    ogTitle: "Baotuo Chat - 本地优先的 AI 对话工作台",
    ogDescription:
      "在一个双语工作台中使用多模型、助理、插件、联网搜索、知识库 RAG、语音和可编辑产物。",
    ogImageAlt: "Baotuo Chat AI 对话工作台",
  ...
  ja: {
    title: "Baotuo Chat - ローカル優先の AI チャットワークスペース",
    description:
      "Baotuo Chat はローカル優先の AI チャットワークスペースです。複数モデルの会話、アシスタントプリセット、プラグインツール、Web 検索、ナレッジベース RAG、音声、編集可能な成果物に対応します。",
    keywords: [
      "Baotuo Chat",
      "AI チャット",
      "ローカル優先 AI",
    ...
    ogTitle: "Baotuo Chat - ローカル優先の AI チャットワークスペース",
    ogDescription:
      "複数モデル、アシスタント、プラグイン、Web 検索、ナレッジベース RAG、音声、編集可能な成果物をひとつのワークスペースで扱えます。",
    ogImageAlt: "Baotuo Chat AI チャットワークスペース",
