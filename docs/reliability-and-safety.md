...
Baotuo Chat remains local-first and self-hosting friendly. Runtime safeguards focus
...
If risk is not provided by the plugin manifest, Baotuo Chat infers it from the HTTP
