...
Baotuo Chat is designed for local-first and self-hosted use. It is not a turnkey
...
https://github.com/baotuo88/BaotuoAi-Chat/security/advisories/new
...
Before running Baotuo Chat as a public service, add account authentication, tenant
